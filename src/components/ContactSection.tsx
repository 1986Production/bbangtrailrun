  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="tracking-tighter leading-none text-black mb-12">Let's Connect</h1>
        <p className="font-medium leading-relaxed text-gray-600 mb-16 max-w-md">
          We believe in the power of digital, and we love collaborating with brands that feel the same. Fill out the form and
        ...
        <div className="mt-auto bg-white p-4 rounded-[2rem] shadow-xl shadow-black/5 border border-black/5 group">
          <div className="overflow-hidden rounded-[1.5rem] aspect-[4/3]">
            <img
              src="/images/officecontact-800x600.jpg"
              alt="Office Location"
        ...
        <form className="flex flex-col space-y-8 bg-white p-8 md:p-12 rounded-[3rem] shadow-xl shadow-black/5 border border-black/5">
          <div className="flex flex-col">
            ...
            <input
              ...
              className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 outline-none text-sm font-medium text-black placeholder:text-gray-400 focus:ring-2 focus:ring-gray-200 transition-shadow"
              required
            />
          </div>
          ...
          <div className="flex flex-col relative">
            ...
            <select
              className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 outline-none text-sm font-medium text-black appearance-none cursor-pointer focus:ring-2 focus:ring-gray-200 transition-shadow"
              required
              defaultValue=""
            >
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              className="w-full bg-gray-50 border-none rounded-2xl px-6 py-4 outline-none text-sm font-medium text-black resize-none placeholder:text-gray-400 h-32 focus:ring-2 focus:ring-gray-200 transition-shadow"
              required
            />
          </div>
          ...
          <div className="pt-6">
            <button
              type="submit"
              className="inline-flex items-center justify-center w-full px-8 py-5 rounded-2xl bg-black text-white text-sm font-medium hover:bg-gray-800 transition-colors group"
            >
