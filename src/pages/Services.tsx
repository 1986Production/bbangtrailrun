  ...
  return (
    <>
      ...
      <section
        ...
        className="services-cards layout-pad-bottom flex flex-col gap-16"
      >
        {services.map((srv, i) => (
      ...
      {/* Services Unpacked */}
      <section
        data-section="services-capabilities"
        className="services-capabilities layout-band bg-black text-white rounded-t-[3rem]"
      >
      ...
      <section
        data-section="services-article"
        className="services-article layout-pad"
      >
      ...
      {/* About Articles Grid */}
      <section
        data-section="services-articles"
        className="services-articles layout-pad-bottom"
      >
      ...
      {/* Featured Project */}
      <section
        data-section="services-project"
        className="services-project layout-pad-bottom"
      >
      ...
      <ServicesEventOverviewSection />

      {/* Campaign Section - Editorial Split Style */}
      <section
        data-section="services-campaign"
        className="services-campaign layout-pad-bottom"
      >
...
const Services = () => {
  return (
    <main data-page="services" className="services animate-in fade-in duration-1000 bg-white">
      <ServicesSections />
    </main>
  );
};
